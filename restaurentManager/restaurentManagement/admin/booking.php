...
<body>
    ...
    <div class="admin-booking">
        <h1 class="admin-book">Welcome Admin To Booking <Section></Section>
        </h1>
        <table>
            <tr>
            ...
            ?>
                <tr>
                    ...
                    <td width="10%" height="50px">
                        <center><?php echo $state; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $city; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $email; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $ci; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $co; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $members; ?></center>
                    </td>
                    <td width="10%" height="50px">
                        <center><?php echo $roomtype; ?></center>
                    </td>
